...
<div class="container py-5">
  ...
  <div class="row mb-4">
    <div class="col-md-6">
      <img src="../uploads/<?= htmlspecialchars($imagePrincipale) ?>" class="img-fluid rounded border" alt="Image principale">
    </div>
    <div class="col-md-6">
      ...
      <?php if (count($images) > 1): ?>
        <div class="mt-3">
          ...
          <?php foreach (array_slice($images, 1) as $img): ?>
            <img src="../uploads/<?= htmlspecialchars($img) ?>" width="80" class="me-2 mb-2 border rounded">
          <?php endforeach; ?>
        </div>
      <?php endif; ?>
    </div>
